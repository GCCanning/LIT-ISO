...
namespace IsoCore.Foundation
{
    ...
    public class FoundationContent
    {
        ...
        public static FoundationContent BuildDefault()
        {
            ...
            // ---- Predator plants (carnivorous, Hostile; render via Resources/Decorations/mobs sprite) ----
            // Art: CraftPix free predator-plant pack (see CREDITS_CHARACTERS.txt). Rooted/slow movers.
            ...
            predPlant1.meleeDamage = 6f; predPlant1.campWardIgnoreChance = 0.2f; predPlant1.sizeUnits = 1.1f;
            ...
            predPlant2.meleeDamage = 9f; predPlant2.campWardIgnoreChance = 0.25f; predPlant2.sizeUnits = 1.15f;
            ...
            predPlant3.meleeDamage = 13f; predPlant3.campWardIgnoreChance = 0.3f; predPlant3.sizeUnits = 1.25f;
            predPlant3.decorationSprite = "mobs/predator_plant_3";

            // ---- Slime variants (ported from legacy Assets/World/Enemies/Enemy_Slime_*) ----
            var slimeCommon = Mob("slime_common", new Color(0.40f, 0.82f, 0.45f), MobBehavior.Hostile, 1.45f, 4f,
                new[] { new ItemDrop("slime_goo", 1, 2) });
