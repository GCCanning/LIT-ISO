...
{
    /// <summary>Generated world-space progress bar for break/harvest feedback.</summary>
    public sealed class WorldProgressBar : MonoBehaviour
    {
        ...
        public void Build(int sortingOrder)
        {
            ...
            _back.transform.localScale = new Vector3(1.22f, 0.16f, 1f);
            ...
            _fill.transform.localScale = new Vector3(0f, 0.11f, 1f);

            gameObject.SetActive(false);
        }

        public void Show(float progress01, float seconds = 1.8f)
        {
            progress01 = Mathf.Clamp01(progress01);
            _hideTimer = Mathf.Max(0.1f, seconds);
            gameObject.SetActive(true);

            float width = 1.12f * progress01;
            _fill.transform.localScale = new Vector3(width, 0.11f, 1f);
            _fill.transform.localPosition = new Vector3(-0.56f + width * 0.5f, 0f, 0f);
        }
