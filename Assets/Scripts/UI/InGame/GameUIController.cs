...
namespace LitIso.UI.InGame
{
    ...
    /// vitals (HP / Mana / Hunger / XP + level) stacked at the bottom-left over an
    /// optional decorative plate.
    ///
    ...
    public sealed class GameUIController : MonoBehaviour
    {
        ...
        {
            // Bottom-left stack: HP / Mana / Hunger / XP (top → bottom).
            ...
            col.sizeDelta = new Vector2(320f, 140f);
            ...
            _manaFill   = Bar(col, "Mana",   1, ManaCol,   "bar_mana_fill");
            _hungerFill = Bar(col, "Hunger", 2, HungerCol, "bar_hunger_fill");
            _xpFill     = Bar(col, "XP",     3, XpCol,     "bar_xp_fill", 14f, "bar_xp_track");
        ...
        Image Bar(RectTransform parent, string name, int row, Color fillCol, string fillSkin, float h = 24f, string trackSkin = "bar_track")
        {
            ...
            tr.sizeDelta = new Vector2(296f, h);
