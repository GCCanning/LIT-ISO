...
| Expose Foundation UI binding contract | Codex | codex/foundation-ui-contract-clean | REVIEW | Ready event + Inventory/Hotbar/Content/World handles + optional IMGUI HUD; dotnet green; Unity batch blocked by open editor |
